...
/***/ function(module, exports, __webpack_require__) {
	...
	var _viewsApp = __webpack_require__(/*! ./views/App */ 4);
	
	var _viewsApp2 = _interopRequireDefault(_viewsApp);
	
	(0, _jquery2['default'])(function () {
	  _react2['default'].render(_react2['default'].createElement(_viewsApp2['default'], null), document.getElementById('app'));
	});
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _get = __webpack_require__(/*! babel-runtime/helpers/get */ 5)['default'];
	
	var _inherits = __webpack_require__(/*! babel-runtime/helpers/inherits */ 19)['default'];
	
	var _createClass = __webpack_require__(/*! babel-runtime/helpers/create-class */ 30)['default'];
	
	var _classCallCheck = __webpack_require__(/*! babel-runtime/helpers/class-call-check */ 33)['default'];
	...
	var _reactSwitchButton = __webpack_require__(/*! react-switch-button */ 34);
	
	var _reactSwitchButton2 = _interopRequireDefault(_reactSwitchButton);
	
	var _AppCanvas = __webpack_require__(/*! ./AppCanvas */ 35);
	
	var _AppCanvas2 = _interopRequireDefault(_AppCanvas);
	
	// Webpack using CSS.
	__webpack_require__(/*! react-switch-button.min.css */ 36);
	__webpack_require__(/*! ./css/app-canvas.css */ 40);
	...
	var App = (function (_React$Component) {
	  ...
	  _createClass(App, [{
	      ...
	      return _react2['default'].createElement(
	        ...
	        _react2['default'].createElement(
	          ...
	          _react2['default'].createElement(
	            'li',
	            null,
	            _react2['default'].createElement(_reactSwitchButton2['default'], { name: 'draw-polygon',
	          ...
	          _react2['default'].createElement(
	            'li',
	            null,
	            _react2['default'].createElement(_reactSwitchButton2['default'], { name: 'drop-point',
	              label_right: 'Drop Point',
	              checked: !this.state.isDrawPolygon,
	              onChange: this._onDrawModeChange.bind(this) })
	          )
	        ),
	        _react2['default'].createElement(_AppCanvas2['default'], { width: canvasWidth, height: canvasHeight,
	    ...
	    key: '_onDrawModeChange',
	    value: function _onDrawModeChange(e) {
	      this.setState({
	        isDrawPolygon: !this.state.isDrawPolygon
	      });
	    }
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _Object$getOwnPropertyDescriptor = __webpack_require__(/*! babel-runtime/core-js/object/get-own-property-descriptor */ 6)["default"];
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = { "default": __webpack_require__(/*! core-js/library/fn/object/get-own-property-descriptor */ 7), __esModule: true };
...
/***/ function(module, exports, __webpack_require__) {
	...
	__webpack_require__(/*! ../../modules/es6.object.get-own-property-descriptor */ 9);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var toIObject = __webpack_require__(/*! ./$.to-iobject */ 10);
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = function(KEY, exec){
	  var $def = __webpack_require__(/*! ./$.def */ 15)
	    , fn   = (__webpack_require__(/*! ./$.core */ 17).Object || {})[KEY] || Object[KEY]
	    , exp  = {};
	  exp[KEY] = exec(fn);
	  $def($def.S + $def.F * __webpack_require__(/*! ./$.fails */ 18)(function(){ fn(1); }), 'Object', exp);
	};
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _Object$create = __webpack_require__(/*! babel-runtime/core-js/object/create */ 20)["default"];
	
	var _Object$setPrototypeOf = __webpack_require__(/*! babel-runtime/core-js/object/set-prototype-of */ 22)["default"];
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = { "default": __webpack_require__(/*! core-js/library/fn/object/create */ 21), __esModule: true };
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = { "default": __webpack_require__(/*! core-js/library/fn/object/set-prototype-of */ 23), __esModule: true };
...
/***/ function(module, exports, __webpack_require__) {
	...
	__webpack_require__(/*! ../../modules/es6.object.set-prototype-of */ 24);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var $def = __webpack_require__(/*! ./$.def */ 15);
	$def($def.S, 'Object', {setPrototypeOf: __webpack_require__(/*! ./$.set-proto */ 25).set});
...
/***/ function(module, exports, __webpack_require__) {
	...
	var getDesc  = __webpack_require__(/*! ./$ */ 8).getDesc
	  , isObject = __webpack_require__(/*! ./$.is-object */ 26)
	  , anObject = __webpack_require__(/*! ./$.an-object */ 27);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var isObject = __webpack_require__(/*! ./$.is-object */ 26);
	module.exports = function(it){
...
/***/ function(module, exports, __webpack_require__) {
	...
	var aFunction = __webpack_require__(/*! ./$.a-function */ 29);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _Object$defineProperty = __webpack_require__(/*! babel-runtime/core-js/object/define-property */ 31)["default"];
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _libPoint = __webpack_require__(/*! ../lib/Point */ 42);
	  ...
	  _createClass(Canvas, [{
	    ...
	    value: function render() {
	      ...
	      if (this.state.svgPath.length) {
	        ...
	        var path = this.state.svgPath.map(function (pt, i) {
	          // Create svg circle.
	          svgCircles.push(_react2['default'].createElement('circle', { cx: pt.x, cy: pt.y, r: '5', stroke: 'green', fill: 'none' }));
	          // Create svg path.
	          if (i === 0) {
	            return 'M' + pt.x + ' ' + pt.y;
	          } else {
	        ...
	        svgPath = _react2['default'].createElement('path', { d: path, stroke: 'green', fill: 'none' });
	      }
	
	      return _react2['default'].createElement(
	        'div',
	        { className: 'noselect' },
	        _react2['default'].createElement('canvas', { width: this._width, height: this._height,
	    ...
	    value: function _onClick(e) {
	      ...
	      if (oldNodes.length == 0) {
	        ...
	        newNodes = oldNodes;
	        [this._lineStartPt, endPt].forEach(function (pt) {
	    ...
	    key: '_startDrawing',
	    value: function _startDrawing(startPt) {
	    ...
	    key: '_stopDrawing',
	    value: function _stopDrawing(endPt) {
	      this._isDrawing = false;
	      this._lineStartPt = false;
	    ...
	    key: '_toCanvasCoords',
	    value: function _toCanvasCoords(x, y) {
	      return new _libPoint2['default'](x - this._boundingClientRect.left, y - this._boundingClientRect.top);
	    }
	  }, {
	    key: '_canvasLineTo',
	    value: function _canvasLineTo(toPt) {
	      // Clear canvas.
	      this._ctx.clearRect(0, 0, this._width, this._height);
...
/* 36 */
/*!****************************************************************!*\
  !*** ./~/react-switch-button/dist/react-switch-button.min.css ***!
  \****************************************************************/
/***/ function(module, exports, __webpack_require__) {
	...
	// load the styles
	var content = __webpack_require__(/*! !./../../css-loader!./react-switch-button.min.css */ 37);
	...
	if(false) {
		...
		if(!content.locals) {
			module.hot.accept("!!./../../css-loader/index.js!./react-switch-button.min.css", function() {
				var newContent = require("!!./../../css-loader/index.js!./react-switch-button.min.css");
...
/* 37 */
/*!*******************************************************************************!*\
  !*** ./~/css-loader!./~/react-switch-button/dist/react-switch-button.min.css ***!
  \*******************************************************************************/
/***/ function(module, exports, __webpack_require__) {
...
/***/ function(module, exports, __webpack_require__) {
	...
	// load the styles
	var content = __webpack_require__(/*! !./../../../~/css-loader!./app-canvas.css */ 41);
	if(typeof content === 'string') content = [[module.id, content, '']];
	// add the styles to the DOM
	var update = __webpack_require__(/*! ./../../../~/style-loader/addStyles.js */ 39)(content, {});
	if(content.locals) module.exports = content.locals;
	...
	if(false) {
		// When the styles change, update the <style> tags
		if(!content.locals) {
			module.hot.accept("!!./../../../node_modules/css-loader/index.js!./app-canvas.css", function() {
				var newContent = require("!!./../../../node_modules/css-loader/index.js!./app-canvas.css");
				if(typeof newContent === 'string') newContent = [[module.id, newContent, '']];
				update(newContent);
			});
		}
...
/* 41 */
/*!*****************************************************!*\
  !*** ./~/css-loader!./src/views/css/app-canvas.css ***!
  \*****************************************************/
/***/ function(module, exports, __webpack_require__) {
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Point = (function () {
	  ...
	  _createClass(Point, [{
	    ...
	    key: "getDistance",
	    value: function getDistance(fromPt) {
